...
@Component({
  ...
  template: `
    <div class="fields">
      ...
      <app-field-errors [control]="field31"/>

      <label>Field 32</label>
      <input appInput #last [formControl]="field32" />
      <app-field-errors [control]="field32"/>
    </div>
  `,
})
export class Sub3Component implements OnDestroy {
  readonly field31 = new FormControl<string>('', Validators.required);
  readonly field32 = new FormControl<string>('', Validators.required);
